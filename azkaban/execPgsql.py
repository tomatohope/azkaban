...
from connectMysql import execsql as Mexecsql
import sys
import os
...
connect = Mexecsql.execsql(azkaban_host, azkaban_user, azkaban_password, azkaban_database, sql, '1', "{}")

#para: database, user, passwd, host port, sql, result,dict
execsql.execsqlfile(connect[0][4], connect[0][2], connect[0][3], connect[0][1], connect[0][5], sys.argv[2], '0', sys.argv[3])
